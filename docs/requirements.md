...
- **Failed second factors:** consecutive failed second-factor answers are counted per account (the owner's decision of 2026-09-25): at 10 the person is told by e-mail, and at 100 codes from an authenticator app or by e-mail are refused, at sign-in and at every step-up, until the password is changed, while security keys and recovery codes still work.
