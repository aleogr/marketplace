...
| **ALI** | Official fee page not retrievable. (secondary) 5–8% by category worldwide (electronics, computers, phones 5%; fashion, beauty, home 8%); Brazilian guides for local sellers: 5–10% by category (5% appliances/telecom/furniture, 8% beauty/health/tools, 10% wigs) [ALI-1][ALI-7][ALI-4][ALI-6] | No listing or monthly fee (secondary) [ALI-6][ALI-7] | Sponsored Products: CPC, typical USD 0,05–0,50 per click (secondary, uncited) [ALI-7] | (secondary) about 2–2,5% per order [ALI-7] |
...
| **ALI** | Local Brazilian sellers: legal entities only (CNPJ: MEI, LTDA, EI, EIRELI, S/A, foreign branch); dropshipping not allowed (secondary) [ALI-5][ALI-6][ALI-4] | CNPJ licence, state registration, address and legal representative; AliExpress approves or rejects (approval time `not found`) (secondary) [ALI-5][ALI-6] | `not found` | `not found` |
...
| **ALI** | Pix accepted at checkout, boleto and cards mentioned (secondary); official list `not found` [ALI-5] | `not found` | Escrow: payment released to the seller after the buyer confirms receipt or the protection period expires (secondary; official page redirects to maintenance) [ALI-2][ALI-1] | Local sellers: up to 7 days after delivery (secondary); international guides: 15-day hold after confirmed delivery, then 1–3 business days via Payoneer/WorldFirst, minimum withdrawal USD 20 (secondary) [ALI-4][ALI-5][ALI-7] | `not found`; returns accepted within 15 days after delivery (secondary) [ALI-6] |
...
| **ALI** | `not found` | "Free domestic shipping options" for local sellers (secondary); details `not found` [ALI-6] | `not found` | All shipments trackable (secondary) [ALI-6] |
...
| **ALI** | `not found` | `not found` | `not found` | `not found` (one listing per seller is the model described by secondary guides) |
...
| **ALI** | A "Vehicles" line appears in a secondary fee table at 5%, presumably parts and small vehicles; whether complete cars are listed `not found` [ALI-7] | `not found` | `not found` | `not found` |
...
| **ALI** | pt.aliexpress.com exists (HTTP 200, client-rendered); listings of local sellers are translated automatically into 18 languages (secondary); UI language list `not found` [ALI-3][ALI-6] | `not found` | Per-language sub-domains (pt., es.); selection mechanism `not found` [ALI-3] | Remessa Conforme: taxes collected at checkout and shown before payment (secondary); since 13 May 2026 (MP 1.357/2026) import tax is 0% up to USD 50 and 60% minus USD 30 above, plus ICMS 17–20% (secondary) [ALI-9][ALI-8] |
...
- Cross-border buying is handled by charging the buyer's estimated import taxes at checkout (ML, Shopee, Amazon, AliExpress), which became standard after Remessa Conforme. Note that the rates quoted by the Shopee and Amazon help pages (20% up to USD 50, 60% minus USD 20 above) predate a May 2026 provisional measure that, per press reports, zeroed the federal tax up to USD 50 and changed the deduction to USD 30 [ALI-8]; the official help pages had not been updated on the access date. Cross-border selling from Brazil is documented only by Amazon (selling on the US site) and eBay (fees by seller region).
...
36. **Add (§5, §29 cross-border):** cross-border buying is implemented by charging the buyer's estimated import taxes at checkout (ML, Shopee, Amazon and AliExpress under Remessa Conforme). The rates changed in May 2026 and the competitors' help pages still show the old ones, which shows that tax rules must be data with effective dates, not code. When cross-border sales are mapped, the order model needs an import-tax line and the rule that the buyer is the importer.
...
- AliExpress: official seller and help pages could not be read (client-rendered or maintenance redirects), so its rows rest on secondary sources and many cells are `not found`; a follow-up session with browser-based reading is needed.
...
- **[ALI-1]** https://sell.aliexpress.com/ (redirects to /us/) — official seller landing; client-rendered, no readable content (fees, registration and payout pages not retrievable).
- **[ALI-2]** https://www.aliexpress.com/buyerprotection/overview.html — official buyer-protection overview; redirected to a maintenance page on the access date.
- **[ALI-3]** https://pt.aliexpress.com/ — Portuguese site, HTTP 200, client-rendered.
- **[ALI-4]** https://ecommercenapratica.com/blog/comissao-aliexpress/ — (secondary, updated 18/07/2025) local-seller commissions 5% / 8% / 10% by category, CNPJ required, no dropshipping, payout within 7 days after delivery.
- **[ALI-5]** https://ecommercenapratica.com/blog/como-vender-aliexpress/ — (secondary, 27/11/2025) legal entities only, documents, commission 5–10%, free registration, payout up to 7 business days after receipt confirmation, Pix at checkout.
- **[ALI-6]** https://www.nuvemshop.com.br/blog/como-vender-no-aliexpress/ — (secondary, updated 08/09/2026) accepted company types, approval by AliExpress, commission 5–10% by category, no monthly fee, payout within 7 days, free domestic shipping options, returns within 15 days, automatic translation into 18 languages.
- **[ALI-7]** https://profitcalcu.com/blog/aliexpress-seller-fees-2026/ — (secondary, June 2026, does not cite official pages) commission 5–8% by category, payment processing ~2–2,5%, no listing or monthly fee, CPC USD 0,05–0,50, 15-day settlement hold, Payoneer/WorldFirst, USD 20 minimum withdrawal.
- **[ALI-8]** https://www.oficinadanet.com.br/importacoes/69512-fim-da-taxa-das-blusinhas-comeca-hoje-entenda-o-que-muda-nas-compras-da-shein-aliexpress-e-shopee — (secondary, 13/05/2026) Medida Provisória 1.357/2026: 0% import tax up to USD 50, 60% minus USD 30 above, ICMS still applies.
- **[ALI-9]** https://favarettoadv.com.br/aliexpress-e-remessa-conforme-como-funcionam-os-impostos-nas-compras — (secondary, search snippet only) AliExpress collects Remessa Conforme taxes at checkout and shows them before payment.
